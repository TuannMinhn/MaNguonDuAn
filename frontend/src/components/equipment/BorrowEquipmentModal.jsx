    ...
    <div className="modal-overlay">
      <div className="modal-content" style={{ maxWidth: '520px' }}>
        <div className="modal-header">
          <h3>{isConsumable ? 'Tạo phiếu xuất kho linh kiện' : 'Tạo phiếu mượn thiết bị'}</h3>
          <button style={iconBtnStyle} onClick={onClose}>
            <X size={20} />
          </button>
        </div>
        <form onSubmit={handleBorrowSubmit}>
          <div className="modal-body" style={{ gap: '1rem', maxHeight: '65vh', overflowY: 'auto' }}>
            ...
            {/* Ô tìm gợi ý thành viên (Tránh gõ bừa MSSV) */}
